  ...
  return (
    <section className="bg-[#F8F9FA] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-12 items-start justify-center max-w-5xl mx-auto">
          {mentorsData.map((mentor) => (
            <div key={mentor.id} className="flex flex-col items-center text-center group">
              <div className="relative w-32 h-32 sm:w-36 sm:h-36 lg:w-40 lg:h-40 rounded-full bg-white p-1 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] mb-5 transition-transform duration-300 ease-in-out group-hover:scale-105">
